        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="{{ route("backenddepts.store") }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label for="Name">Name</label>
                            <input id="Name" type="text" name="name" data-parsley-trigger="change" required placeholder="Department Name" autocomplete="off" class="form-control @error('name') is-invalid @enderror">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="slug" type="text" name="slug" data-parsley-trigger="change" required placeholder="Department Slugan" autocomplete="off" class="form-control @error('slug') is-invalid @enderror">
                            @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" row="3" name="description" data-parsley-trigger="change" placeholder="Department description" required  autocomplete="off" class="form-control @error('description') is-invalid @enderror"></textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="number" id="qty" name="qty" data-parsley-trigger="change" placeholder="Quantity" required  autocomplete="off" class="form-control @error('qty') is-invalid @enderror">
                            @error('qty')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input id="meta_title" type="text" name="meta_title" data-parsley-trigger="change" placeholder="Meta_title" required  autocomplete="off" class="form-control @error('meta_title') is-invalid @enderror">
                            @error('meta_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
